...
def create_csv_fresh_air_flowrates(_df_vent: pd.DataFrame, _output_path: pathlib.Path) -> None:
    ...
    flowRate_Sup_High = rm_vent_df2["V_Supply"].values * rm_vent_df2["Reduction Factor 1"].values * unitFactor_flow
    flowRate_Eta_High = rm_vent_df2["V_Extract"].values * rm_vent_df2["Reduction Factor 1"].values * unitFactor_flow
    # flowRate_Trans_High = (
    ...
    flowRate_Sup_Med = rm_vent_df2["V_Supply"].values * rm_vent_df2["Reduction Factor 2"].values * unitFactor_flow
    flowRate_Eta_Med = rm_vent_df2["V_Extract"].values * rm_vent_df2["Reduction Factor 2"].values * unitFactor_flow
    # flowRate_Trans_Med = (
    #     rm_vent_df2["V_Transmission"].values
    ...
    flowRate_Sup_Low = rm_vent_df2["V_Supply"].values * rm_vent_df2["Reduction Factor 3"].values * unitFactor_flow
    flowRate_Eta_Low = rm_vent_df2["V_Extract"].values * rm_vent_df2["Reduction Factor 3"].values * unitFactor_flow
    # flowRate_Trans_Low = (
    #     rm_vent_df2["V_Transmission"].values
    ...
    roomVol = pd.DataFrame(rm_vent_df2["Room Vol."].values * unitFactor_vol, columns=["Room Vol. (ft3)"])
    roomArea = pd.DataFrame(rm_vent_df2["Area"].values * unitFactor_area, columns=["Room Area (ft2)"])
