...
"""GHCompo Interface: HBPH+ - Read Climate Data from PHPP."""
...
class GHCompo_ReadPHPPClimateData(object):
    ...
    def get_csv_output_file_path(self):
        ...
        filename = self.filename or "phpp_data_climate_{}.csv".format(datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
