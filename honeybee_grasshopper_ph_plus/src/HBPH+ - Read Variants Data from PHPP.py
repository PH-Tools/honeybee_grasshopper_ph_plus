...
#
"""
Read in the Variants Results data from the open (active) PHPP document.
...
EM March 8, 2025
    ...
    Returns:
        variants_data_: The path to the CSV file generated from the PHPP.
"""
...
ghenv.Component.Name = "HBPH+ - Read Variants Data from PHPP"
DEV = honeybee_ph_plus_rhino._component_info_.set_component_params(ghenv, dev=False)
if DEV:
    reload(gh_io)
    from honeybee_ph_plus_rhino.gh_compo_io import run_subprocess
    reload(run_subprocess)
...
# ------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_ReadPHPPVariantsData(
    IGH, _folder_, _filename_, _phpp_file_, _run,
)
variants_data_ = gh_compo_interface.run()