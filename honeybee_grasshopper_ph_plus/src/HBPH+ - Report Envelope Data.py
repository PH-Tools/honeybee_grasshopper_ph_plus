...
if DEV:
    from honeybee_ph_plus_rhino.reporting import build_env_surfaces as gh_compo_io
    reload(gh_compo_io)
...
# ------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_CreateEnvelopeSurfaces(
            IGH,
            _hb_model,
...
(face_const_names_, face_geometry_, face_rh_attributes_, face_areas_) = gh_compo_interface.run()
