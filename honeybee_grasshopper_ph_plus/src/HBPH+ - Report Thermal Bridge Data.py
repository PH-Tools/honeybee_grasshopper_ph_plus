...
if DEV:
    from honeybee_ph_plus_rhino.reporting import build_thermal_bridges as gh_compo_io
    reload(gh_compo_io)
...
# ------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_CreateThermalBridges(
            IGH,
            _hb_model,
...
tb_names_, tb_geometry_, tb_rh_attributes_, tb_lengths_ = gh_compo_interface.run()